Webruntime.define('lwc/imageSlider', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".gh" + shadowSelector + "{height:175px;width:230px;}\n.lgc-bg" + shadowSelector + " {background-color: rgb(242, 242, 242);}\n.lgc-bg-inverse" + shadowSelector + " {background-color: rgb(22, 50, 92);}\n";
    }
    ...
    class ImageSlider extends lwc.LightningElement {
      ...
      imgSlide() {
        ...
        for (let i = 0; i < img.length; i++) {
          this.imgSlider = 'https://images.unsplash.com/photo-1529736576495-1ed4a29ca7e1?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9';
        }
      }
