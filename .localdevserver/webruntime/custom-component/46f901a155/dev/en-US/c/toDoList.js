Webruntime.define('lwc/toDoList', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          key: 9
        }, [$cmp.idForEdit ? api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          props: {
    ...
    class ToDoList extends lwc.LightningElement {
      ...
      editTask(event) {
        var id1 = event.target.name;
        let todoTaskk = this.todoTasks;
        console.log(id1);
        this.idForEdit = id1; //var inp=this.template.querySelector('lightning-input').create('fields');
        //var inpp=LWC.createElement('input');
        // console.log(inp);
