Webruntime.define('lwc/parentProperty', ['lwc', 'lightning/configProvider', 'c/properites', 'lightning/layoout'], function (lwc, configProvider, _cProperites, _lightningLayoout) { 'use strict';

    _cProperites = _cProperites && Object.prototype.hasOwnProperty.call(_cProperites, 'default') ? _cProperites['default'] : _cProperites;
    _lightningLayoout = _lightningLayoout && Object.prototype.hasOwnProperty.call(_lightningLayoout, 'default') ? _lightningLayoout['default'] : _lightningLayoout;
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          key: 0,
          on: {
            "tileclick": _m0 || ($ctx._m0 = api_bind($cmp.tileInfo))
          }
        }, [])]);
      }))]), api_custom_element("lightning-layoout", _lightningLayoout, {
        key: 5
      }, [api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        key: 4
      }, [api_text("you have selected:"), api_dynamic($cmp.divSelected)])])];
    }
