    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          key: 3,
          on: {
            "click": _m0 || ($ctx._m0 = api_bind($cmp.saveTask))
          }
        }, [])])])])]);
        ...
        return api_element("li", {
          ...
          key: 9,
          on: {
            "click": _m1 || ($ctx._m1 = api_bind($cmp.deleteTask))
          }
        }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          classMap: {
          ...
          key: 11,
          on: {
            "click": _m2 || ($ctx._m2 = api_bind($cmp.editTask))
          }
        }, [])])])])]);
      })]))])]), api_element("p", {
        attrs: {
        ...
        key: 19,
        on: {
          "change": _m3 || ($ctx._m3 = api_bind($cmp.updateTaskValue))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "flexibility": "auto",
        ...
        key: 21,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.addTaskItem))
        }
      }, [])])])])])];
    }
