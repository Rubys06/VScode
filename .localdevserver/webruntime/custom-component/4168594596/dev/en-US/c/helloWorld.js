Webruntime.define('lwc/helloWorld', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0
      }, [api_text("Hello, "), api_dynamic($cmp.greeting), api_text("!")]), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Name",
          "value": $cmp.greeting
        },
        key: 1,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.changeHandler))
        }
      }, [])])])];
    }
