Webruntime.define('lwc/createAccoundLDS', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.nameChangeHandler))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Phone",
        ...
        key: 1,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.phoneChangeHandler))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "label": "Email",
        ...
        key: 2,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.emailChangeHandler))
        }
        ...
        key: 3,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.accountCreation))
        }
      }, [])])])])])];
    }
    ...
    tmpl$p.stylesheetTokens = {
      hostAttribute: "lwc-createAccoundLDS_createAccoundLDS-host",
      shadowAttribute: "lwc-createAccoundLDS_createAccoundLDS"
    };

    class CreateAccoundLDS extends lwc.LightningElement {}

    var createAccoundLDS = lwc.registerComponent(CreateAccoundLDS, {
      tmpl: _tmpl$o
    });

    return createAccoundLDS;
