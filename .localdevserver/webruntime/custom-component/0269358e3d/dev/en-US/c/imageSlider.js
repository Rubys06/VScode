Webruntime.define('lwc/imageSlider', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".gh" + shadowSelector + "{height:1000px;width:500px;}\n";
    }
