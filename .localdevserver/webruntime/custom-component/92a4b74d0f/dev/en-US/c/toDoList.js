Webruntime.define('lwc/toDoList', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          key: 9
        }, [$cmp.isId ? api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          props: {
          ...
          key: 1
        }, [])]) : null, !$cmp.idForEdit ? api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          props: {
            "padding": "horizontal-small"
          },
          key: 3
        }, [api_dynamic(todoItems.name)]) : null, api_element("div", {
          classMap: {
          ...
          key: 4,
          on: {
            "click": _m0 || ($ctx._m0 = api_bind($cmp.deleteTask))
          }
        }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
          classMap: {
          ...
          key: 6,
          on: {
            "click": _m1 || ($ctx._m1 = api_bind($cmp.editTask))
          }
        }, [])])])])]);
      }))])]), api_element("p", {
        attrs: {
        ...
        key: 14,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.updateTaskValue))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "flexibility": "auto",
        ...
        key: 16,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.addTaskItem))
        }
      }, [])])])])])];
    }
    ...
    class ToDoList extends lwc.LightningElement {
      ...
      editTask(event) {
        var idd = event.target.name; //let todoTaskk=this.todoTasks;

        console.log(idd); //this.idForEdit=id1;

        if (this.todoTasks.forEach(todoItems => this.isId = todoItems.Id === idd)) {
          this.isId = 'true';
        } //  {
        //   if(this.todoTasks.todoItems.Id === idd){
        //     this.isId='true';
        //   }
        //  }
