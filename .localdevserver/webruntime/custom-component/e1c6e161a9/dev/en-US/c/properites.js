Webruntime.define('lwc/properites', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$7($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 3,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.divclicked))
        }
      }, [api_custom_element("lightning-tile", _lightningTile, {
        props: {
          "label": $cmp.meetngRoomInfo.roomName,
        ...
        key: 0
      }, [api_text("label:"), api_dynamic($cmp.meetngRoomInfo.roomName), api_text(" ")]), api_element("p", {
        classMap: {
          "slds-truncate": true
        },
        key: 1
    ...
    class Properites extends lwc.LightningElement {
      ...
      //={roomName:'uh',roomCapacity:44};
      divclicked() {
        const tilecliked = new CustomEvent('tileClick', {
          detail: this.meetngRoomInfo
        });
