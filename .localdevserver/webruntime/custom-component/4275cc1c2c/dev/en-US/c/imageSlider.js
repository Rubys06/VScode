Webruntime.define('lwc/imageSlider', ['lwc'], function (lwc) { 'use strict';
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 1,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.imageCounter))
      }
    }, [api_element("img", {
      styleMap: {
        "width": "235px",
  ...
  class ImageSlider extends lwc.LightningElement {
    ...
    imgSlide(imagetodisplay) {
      ...
      for (let i = 0; i < img.length; i++) {
        ...
        setTimeout(() => {
          this.imgSlide(this.imgcounte);
        }, 1000);
        console.log("hello");
      } //setTimeout(this.imgSlide,2000);

    } //    imageCounter(){
    //       setTimeout(() => { this.imgSlide(this.imgcounte)
    //       }, 1000);
    //       console.log("hello");
    //    }
