Webruntime.define('lwc/imageSlider', ['lwc'], function (lwc) { 'use strict';
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    ...
    return [api_element("div", {
      ...
      key: 0
    }, [api_text("https://images.unsplash.com/photo-1529736576495-1ed4a29ca7e1?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9")])];
  }
