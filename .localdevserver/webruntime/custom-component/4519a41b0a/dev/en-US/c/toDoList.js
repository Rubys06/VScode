    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 17
      }, api_flatten([$cmp.todoTask.hasMore ? api_iterator($cmp.todoTask, function (todoItems) {
        return api_element("li", {
          classMap: {
            "slds-item": true
          },
      ...
      }) : [], !$cmp.todoTask.hasMore ? api_iterator($cmp.todoTasks, function (todoItems) {
        return api_element("li", {
          classMap: {
            "slds-item": true
          },
          key: api_key(16, todoItems.id)
        }, [api_custom_element("lightning-layout", _lightningLayout, {
          props: {
            "verticalAlign": "center",
            "horizontalAlign": "spread"
