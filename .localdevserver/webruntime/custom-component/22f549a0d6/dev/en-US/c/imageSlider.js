Webruntime.define('lwc/imageSlider', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".lgc-bg" + shadowSelector + " {background-color: rgb(242, 242, 242);height:175px;width:230px;}\n.lgc-bg-inverse" + shadowSelector + " {background-color: rgb(22, 50, 92);}\n";
    }
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        classMap: {
          "slds-size_6-of-12": true
        },
        key: 1
      }, [api_dynamic($cmp.imgSlider), api_element("p", {
        key: 0
      }, [api_text("hello")])])];
    }
