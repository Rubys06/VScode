    ...
    * */
    ...
    function tmpl$p($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          key: 1
        }, []), api_dynamic(todoItems.name), api_text(" </lightning-input>")]), api_element("div", {
          classMap: {
    ...
    class ToDoList extends lwc.LightningElement {
      ...
      editTask(event) {
        ...
        let todoTaskk = this.todoTasks;
        console.log(JSON.stringify(this.todoTasks)); //var inp=this.template.querySelector('lightning-input').create('fields');
        //var inpp=LWC.createElement('input');
        // console.log(inp);

        this.open = true;
        todoTaskk.splice(todoTaskk.indexOf(id), 1, editable = 'true');
      }
