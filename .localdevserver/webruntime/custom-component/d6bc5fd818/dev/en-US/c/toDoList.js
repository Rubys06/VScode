    ...
    * */
    ...
    class ToDoList extends lwc.LightningElement {
      ...
      editTask(event) {
        ...
        let todoTaskk = this.todoTasks;
        console.log(JSON.stringify(this.todoTasks)); //var inp=this.template.querySelector('lightning-input');

        var inpp = LWC.createElement('input'); // console.log(inp);

        todoTaskk.splice(todoTaskk.indexOf(id), 1, inpp);
      }
